...
pub fn load_audio_track(loader: &Loader, world: &World, file: &str) -> SourceHandle { loader.load(file, OggFormat, (), &world.read_resource()) }

/// Initialise audio in the world. This includes the background track and the
/// sound effects.
pub fn initialise_audio(world: &mut World) {
    use crate::{AUDIO_BOUNCE,
                AUDIO_MUSIC,
                AUDIO_SCORE};
    ...
    let (sound_effects, music) = {
        ...
        let sound = Sounds { bounce_sfx: load_audio_track(&loader, world, AUDIO_BOUNCE),
